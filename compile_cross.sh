...
if [[ ${ARCH} == *mingw* ]]; then
LIBFTDI1_EXTRAFLAGS="-DCMAKE_TOOLCHAIN_FILE=$LIBFTDI1_DIR/Toolchain-mingw32.cmake -DBUILD_SHARED_LIBS=OFF -DCMAKE_RC_COMPILER=\"$(which i686-w64-mingw32-windres)\" -DDLLTOOL=\"$(which i686-w64-mingw32-dlltool)\" -DCMAKE_C_COMPILER_WORKS=1 -DCMAKE_CROSSCOMPILING=1"
fi
